  ...
  return (
    <ParallaxScrollView headerBackgroundColor={{light: "#D0D0D0", dark: "#353636"}} headerImage={<IconSymbol size={310} color='#808080' name='chevron.left.forwardslash.chevron.right' style={styles.headerImage} />}>
      ...
      <Collapsible title='Images'>
        ...
        <Image source={require("@/assets/images/logos/react-logo.png")} style={{alignSelf: "center"}} />
      ...
      <Collapsible title='Animations'>
        <ThemedText>
          This template includes an example of an animated component. The <ThemedText type='defaultSemiBold'>components/HelloWave.tsx</ThemedText> component uses the powerful <ThemedText type='defaultSemiBold'>react-native-reanimated</ThemedText> library to create a waving hand
          animation.
        </ThemedText>
        {Platform.select({
          ios: (
